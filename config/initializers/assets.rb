...
Rails.application.config.assets.precompile += %w( clubs.css )
Rails.application.config.assets.precompile += %w( clubs.js )
...
Rails.application.config.assets.precompile += %w( crap.css )
